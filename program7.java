...
public class Program7 {
    ...
    public static void insertionSortStrings(String array[]){ //insertion Sort for Strings
        for(int i = 1; i < array.length; ++i){
            String temp = array[i];
            int j = i - 1;
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            while((line = reader.readLine()) != null){
                ...
                insertionSortNum[arrayIndexNum] = number;
            ...
            while((line2 = reader2.readLine()) != null){
                ...
                insertionSortString[arrayIndexString] = line2;
                arrayIndexString++;
            }
            ...
            long startTimeInsertionSortTimeNum = System.nanoTime();
            insertionSort(insertionSortNum);
            long insertionSortTimeNum = System.nanoTime() - startTimeInsertionSortTimeNum;
            ...
            writer.write("Insertion Sort Time for Integers: " + insertionSortTimeNum + " NanoSeconds (nS) \n"); // end of part 1
            ...
            long startTimeInsertionSortString = System.nanoTime();
            insertionSortStrings(insertionSortString);
            long insertionSortTimeStrings = System.nanoTime() - startTimeInsertionSortString;// Insertion Sort Time Strings
            int arrayBubbleSortStringSize = arrayBubbleSortString.length;
            //writerTest.write(Arrays.toString(insertionSortString)); // test Sorts
            ...
            writer.write("ArrayList Sort Time for Strings: " + ArrayListSortTimeString + " NanoSeconds (nS)\n");
            writer.write("Insertion Sort Time for Strings: " + insertionSortTimeStrings + " NanoSeconds (nS)" ); // end for part 2
            reader.close();
            writer.close();
        } catch (IOException e){
            e.printStackTrace();
